...
joint.shapes.org.Member = joint.dia.Element.extend({
    ...
    markup: '<g class="rotatable"><g class="scalable"><rect class="card"/><image/></g><text class="cargo"/><text class="nombre"/><text class="correo"/><text class="tel"/><text class="ext"/><text class="cel"/></g>',
